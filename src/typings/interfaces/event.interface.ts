...
export interface eventInterface {
  ...
  disableDnD?: boolean | modeType[]; // Disable Drag and Drop for this event, in the modes specified
  disableResize?: boolean | modeType[]; // Disable Resize for this event, in the modes specified
